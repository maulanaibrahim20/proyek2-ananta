            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);"><i
                            class="side-menu__icon fe fe-layers"></i><span class="side-menu__label">Akun</span><i
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0);"><i
                            class="side-menu__icon fe fe-server"></i><span class="side-menu__label">Content</span><i
                            class="angle fa fa-angle-right"></i></a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Content</a></li>
                        <li><a href="{{ url('/admin/content') }}" class="slide-item"> Content Makeup</a></li>
                    </ul>
                </li>

                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ url('/owner/katalog_makeup') }}"><i
                            class="side-menu__icon fe fe-home"></i><span class="side-menu__label">Katalog
                            Makeup</span></a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ url('/owner/type_makeup') }}"><i
                            class="side-menu__icon fa fa-paint-brush"></i><span class="side-menu__label">Type
                            Makeup</span></a>
                </li>
            </ul>
