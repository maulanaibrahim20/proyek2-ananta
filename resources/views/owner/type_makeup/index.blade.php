        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Tambah Data Type Makeup </h6><button aria-label="Close" class="btn-close"
                    ...
                    <form action="{{ url('/owner/type_makeup/' . $edit->id) }}" method="post">
                        ...
                        <div class="modal-body">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-label">Nama Type Makeup</label>
                                    <input class="form-control  mb-4 is-valid state-valid" value="{{ $edit->name }}"
