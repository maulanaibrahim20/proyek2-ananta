        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Tambah Data Makeup</h6><button aria-label="Close" class="btn-close"
                    ...
                    <div class="modal-body">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input class="form-control  mb-4 is-valid state-valid" placeholder="Masukan nama makeup"
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input class="form-control  mb-4 is-valid state-valid" placeholder="Masukan deskripsi"
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <input class="form-control  mb-4 is-valid state-valid" placeholder="Masukan image"
